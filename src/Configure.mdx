...
<Meta title="Homework 3" />

<div className="sb-container">
  <div className='sb-section-title'>
    # This is the work of student Heru Rubin
    <p>
      Location: Boston MA USA
    </p>

    <p>
      This is a StoryBook JS container for showcasing and testing React components.
      It is a great tool for developing and testing React components in isolation.
      It also allows you to test different variations and modes of the same component.
    </p>
  </div>
